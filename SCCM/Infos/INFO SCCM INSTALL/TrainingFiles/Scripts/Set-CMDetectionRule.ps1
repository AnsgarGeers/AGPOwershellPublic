#Examples: 
#Registry Only: Set-CMDetectionRule -ApplicationName "App-V Client 5.0" -DeploymentTypeName "App-V client for Windows 8 x64" -CreateRegistryValidation -RegistryKey "SOFTWARE\Microsoft\AppV\Client" -RegistryKeyValue "Version" -RegistryKeyValidationValue "5.2"
#MSI Only: Set-CMDetectionRule -ApplicationName "App-V Client 5.0" -DeploymentTypeName "App-V client for Windows 8 x64" -CreateMSIValidation -MSIProductCode "{6313DBA3-0CA9-4CD8-93B3-373534146B7B}"
#File Only: Set-CMDetectionRule -ApplicationName "App-V Client 5.0" -DeploymentTypeName "App-V client for Windows 8 x64" -CreateFileValidation -FolderPath "%ProgramFiles%\Mozilla Firefox" -FileName "firefox.exe" -IsPath64bit $false  -FileValidationValue "40.0"
#MSI & Registry: Set-CMDetectionRule -ApplicationName "App-V Client 5.0" -DeploymentTypeName "App-V client for Windows 8 x64" -CreateRegistryValidation -RegistryKey "SOFTWARE\Microsoft\AppV\Client" -RegistryKeyValue "Version" -RegistryKeyValidationValue "5.2" -CreateMSIValidation -MSIProductCode "{6313DBA3-0CA9-4CD8-93B3-373534146B7B}"
...
Function Set-CMDetectionRule {
	Param (
		...
		[parameter(Mandatory = $false)][string]$RegistryKeyValue,
