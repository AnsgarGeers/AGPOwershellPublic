...
Add-CMApplicationCatalogWebsitePoint -ApplicationWebServicePointServerName "$servername" -CommunicationType HTTP -SiteSystemServerName "$servername" -ClientConnectionType Intranet -NetBiosName $servernameNetbios -OrganizationName "Training Lab" -Port 80 -SiteCode $SiteCode
