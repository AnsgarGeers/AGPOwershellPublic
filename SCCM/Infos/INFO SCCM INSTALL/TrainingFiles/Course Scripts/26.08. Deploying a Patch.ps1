...
Start-Sleep 10
Start-CMSoftwareUpdateDeployment -CollectionName "$ColName" -SoftwareUpdateGroupName "$SupGroup" -AcceptEula -DeploymentType Available -DownloadFromMicrosoftUpdate $True -VerbosityLevel AllMessages
